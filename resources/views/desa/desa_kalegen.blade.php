...
<div class="container-fluid p-0">
  ...
  <div class="row">
    <div class="col-12 p-0">
      <img src="{{ asset('img\foto desa\desa kalegen.jpg') }}" class="post-banner-image" alt="Full-width Picture">
    </div>
  </div>
    ...
    <div class="row">
      <div class="umpak-sumbing col-lg-8 mb-4">
        ...
        <section>
          ...
          <hr>
          <section>
            <img src="{{ asset('img\foto desa\desa kalegen.jpg') }}" class="img-fluid my-3 w-100" alt="Blog Image" style="height: 20rem; object-fit: cover;">
